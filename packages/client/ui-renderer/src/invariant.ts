/**
 * Package-owned invariant companion for `@mutantcat/dsh-client-ui-renderer`.
 * @module @mutantcat/dsh-client-ui-renderer/invariant
 */
...
import type { SlotMap } from '@mutantcat/dsh-client-ui-slots'
import type { InvariantInstaller } from '@mutantcat/dsh-invariants'

const PACKAGE_NAME = '@mutantcat/dsh-client-ui-renderer'
