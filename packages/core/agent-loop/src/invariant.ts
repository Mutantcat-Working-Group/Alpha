 ...
 * @module @mutantcat/dsh-agent-loop/invariant
 */

import type { Context } from '@mutantcat/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@mutantcat/dsh-llm'
import type { InvariantFailure, InvariantInstaller } from '@mutantcat/dsh-invariants'
import { foldRequestHeader } from '@mutantcat/dsh-session'

const PACKAGE_NAME = '@mutantcat/dsh-agent-loop'
