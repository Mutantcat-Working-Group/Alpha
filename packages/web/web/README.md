...
- name: '@mutantcat/dsh-web-fetch-http'
```
...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-web) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-web) — every accepted config field and its source declaration.
