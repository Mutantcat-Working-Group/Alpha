...
import { createScope, scopeOf } from '@mutantcat/dsh-scope'
import type { Scope, ScopeKey } from '@mutantcat/dsh-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@mutantcat/dsh-system-prompt'
import type { Config, PromptAssembly } from '@mutantcat/dsh-system-prompt'
