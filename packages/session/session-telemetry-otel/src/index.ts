 ...
 *
 * @module @mutantcat/dsh-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@mutantcat/schemastery'
import type { Context } from '@mutantcat/cordis'
import type {} from '@mutantcat/dsh-command-feedback'
import type {} from '@mutantcat/dsh-message-feedback'
import { Session, type SessionEvent } from '@mutantcat/dsh-session'
import {
...
} from '@mutantcat/dsh-session-telemetry'
import { APP_IDENTITY } from '@mutantcat/dsh-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@mutantcat/dsh-session-telemetry-otel', version)
