 ...
 *
 * @module @mutantcat/dsh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@mutantcat/dsh-shell'
import type { SandboxMode } from '@mutantcat/dsh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@mutantcat/dsh-sandbox'
 ...
 * rendering story, owned by `@mutantcat/dsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@mutantcat/dsh-shell'
