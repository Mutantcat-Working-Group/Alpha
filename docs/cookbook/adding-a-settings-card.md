...
import type {} from '@mutantcat/dsh-client-ui-settings-plugins/client'
...
```jsonc
{
  ...
  "dsh": { "client": { "platform": "web", "inject": ["@mutantcat/dsh-client-ui-settings-plugins"] } }
}
```
...
export default clientBundle('@mutantcat/dsh-client-my-plugin', ['lib/types/index.js', 'lib/types/invariant.js'])
```
