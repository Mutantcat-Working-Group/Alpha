...
import type { CommandDefinitionId } from '@mutantcat/dsh-commands/brand'
...
import type { CommandResult } from '@mutantcat/dsh-commands'
...
export function apply(ctx: Context, config: Config = {}): void {
  ctx.effect(() => ctx.commands.register({
    definitionId: brandString<CommandDefinitionId>('@mutantcat/dsh-session-log-export'),
    name: 'export',
