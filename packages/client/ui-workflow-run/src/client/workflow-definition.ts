...
import type { ChatConversationViewNode } from '@mutantcat/dsh-client-ui-chat/client'
import type { SessionId } from '@mutantcat/dsh-session/types'
import type {
  ToolWorkflowAgentEndData, ToolWorkflowAgentStartData,
} from '@mutantcat/dsh-tool-workflow/types'
import type { WorkflowAgentOutcome, WorkflowStopReason } from '@mutantcat/dsh-workflow/types'
...
declare module '@mutantcat/dsh-client-ui-chat/client' {
