...
- name: '@mutantcat/dsh-typert-loader'
```
...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-typert-loader) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-typert-loader) — the `packages` field declaration and JSDoc.
