 ...
 * @module @mutantcat/dsh-client-test-runtime/src/assembly/test-client
 */
import { Context, type Plugin } from '@mutantcat/cordis'
import type { Entry } from '@mutantcat/cordis-plugin-loader'
import { tearDownEntryFiber } from '@mutantcat/dsh-client-modules/client'
import {
  installConnection,
  type ConnectionHandle,
} from '@mutantcat/dsh-client-connection/client'
import { bootClient } from '@mutantcat/dsh-client-web/src/boot-client.ts'
import { mountClient } from '@mutantcat/dsh-client-web/src/mount.ts'
import type { RemoteMock } from '@mutantcat/dsh-remote-mock'
...
const CONNECTION_PACKAGE = '@mutantcat/dsh-client-connection'
...
export class TestClient {
   ...
   * its readiness behavior. The `@mutantcat/dsh-api-remotes` row is
