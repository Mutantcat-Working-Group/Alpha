...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@mutantcat/dsh-typert-generator'
import type { CordisCatalogPolicy } from '@mutantcat/dsh-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@mutantcat/cordis'`
 ...
 * scan reads EVERY `declare module '@mutantcat/cordis'` Events merge under
