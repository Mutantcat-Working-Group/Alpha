...
import type { PropsLocale, PropsRenderSlots, PropsRuntime, PropsStore } from '@mutantcat/dsh-client-ui-slots'
...
declare module '@mutantcat/dsh-client-ui-session/client' {
