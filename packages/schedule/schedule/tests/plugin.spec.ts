...
import { SessionLogOffset, SessionId } from '@mutantcat/dsh-session'
...
import type { SessionAccess, SessionHandle, SessionPersistenceSnapshot } from '@mutantcat/dsh-session-persistence'
