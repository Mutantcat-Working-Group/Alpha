...
import type { Session, SessionEvent, SessionHeader, SessionId as SessionIdType } from '@mutantcat/dsh-session'
...
import { type SessionQueryErrorCode } from '@mutantcat/dsh-session-query'
