...
import SessionStore, { Session, SessionId, type UserMessage } from '@mutantcat/dsh-session'
...
import GoalService, {
  ...
  decodeGoalChange,
  foldGoal,
} from '@mutantcat/dsh-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@mutantcat/dsh-goal'
...
function stubAgent(
  rawId: string,
  seed?: readonly import('@mutantcat/dsh-session').SessionEvent[],
  ctx?: Context,
): StubAgent {
