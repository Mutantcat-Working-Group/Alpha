 ...
 * repository.
 * @module @mutantcat/dsh-client-test-runtime/src/assembly/bundle-roster
 */
...
import { applyEntryPatches, entryListSchema, type PatchOptions } from '@mutantcat/cordis-plugin-include'
import { exactPackageSpecifier, parseDshClient } from '@mutantcat/dsh-client-modules/client'
...
export const WEB_PROFILE_BUNDLES: readonly string[] = ['@mutantcat/dsh-base', '@mutantcat/dsh-web-app']
