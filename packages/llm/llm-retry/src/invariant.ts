/** Package-owned durable retry-event invariants. @module @mutantcat/dsh-llm-retry/invariant */

import type { Context } from '@mutantcat/cordis'
import type { Session, SessionEvent } from '@mutantcat/dsh-session'
import type { LlmFailure } from '@mutantcat/dsh-llm'
...
const PACKAGE_NAME = '@mutantcat/dsh-llm-retry'
