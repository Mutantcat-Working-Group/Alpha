 ...
 * `@mutantcat/dsh-cmdline`). Launcher flags therefore come first: the first
...
export function parseDshArgs(argv: readonly string[], version: string): DshInvocation {
  ...
  program
    ...
    .description('dsh: boot an Alpha profile — an ordered stack of plugin-bundle patch layers under your own overrides.')
