...
- [生成的工具目录](../../docs/tool-catalog.zh.md#mutantcatdsh-tool-cordis)——两个只读工具 schema。
- [生成的配置目录](../../docs/config-catalog.zh.md#mutantcatdsh-cordis-host-runner)——runner 的受支持配置字段。
