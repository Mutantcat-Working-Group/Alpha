...
import type { AssistantStreamRecord } from '@mutantcat/dsh-llm'
import { SessionSeq } from '@mutantcat/dsh-session/types'
import type { SessionEvent, SessionEventMap } from '@mutantcat/dsh-session/types'
import type {
  SessionEventEntry,
  SessionHistoryRecord,
  SessionWireEvent,
} from '@mutantcat/dsh-api-session-controller/types'
import { historyEntries } from '@mutantcat/dsh-api-session-controller/src/client/sessions/history-records.ts'
import type { SessionEventLikeEntry } from '@mutantcat/dsh-api-session-controller/client'
import { ConversationNodeAssembler } from '@mutantcat/dsh-client-ui-conversation/client'
import type {
