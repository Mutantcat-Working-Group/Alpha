...
import type { CordisCatalogModel, ServiceMethodEntry } from '@mutantcat/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    ...
    .replaceAll('@mutantcat/dsh-tool-cordis/api-catalog', '@mutantcat/dsh-cordis-client-runner/client/api-catalog')
