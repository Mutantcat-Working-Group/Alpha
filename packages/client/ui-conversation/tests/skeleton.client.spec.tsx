...
import type { SessionListState, SessionSnapshot } from '@mutantcat/dsh-api-session-controller/client'
import type { WorkspaceSnapshot, WorkspaceView } from '@mutantcat/dsh-api-workspace-controller/client'
