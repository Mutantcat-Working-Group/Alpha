 ...
 * @module @mutantcat/dsh-tool-fs/src/write
 */

import type { Context } from '@mutantcat/cordis'
import { defineTool } from '@mutantcat/dsh-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@mutantcat/dsh-tools'
import type { FsWriteOutcome } from '@mutantcat/dsh-fs'
