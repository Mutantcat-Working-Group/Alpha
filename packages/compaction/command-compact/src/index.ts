 ...
 * @module @mutantcat/dsh-command-compact
 */

import type { Context } from '@mutantcat/cordis'
import { CommandDefinitionId } from '@mutantcat/dsh-commands/brand'
import { ManualCompactionError } from '@mutantcat/dsh-compaction'
...
export function apply(ctx: Context): void {
  ...
  ctx.effect(function* () {
    ...
    yield ctx.commands.register({
      definitionId: CommandDefinitionId('@mutantcat/dsh-command-compact'),
      name: 'compact',
