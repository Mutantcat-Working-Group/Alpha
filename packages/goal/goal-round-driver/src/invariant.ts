/** Package-owned goal-round prompt invariants. @module @mutantcat/dsh-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@mutantcat/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@mutantcat/dsh-goal'
...
const PACKAGE_NAME = '@mutantcat/dsh-goal-round-driver'
