...
import { SANDBOX_MODES, setSandboxMode } from '@mutantcat/dsh-sandbox-policy'
...
import type {} from '@mutantcat/dsh-shell'
import type { ApprovalPolicy } from '@mutantcat/dsh-user-approval'
import { APPROVAL_POLICIES, setApprovalPolicy } from '@mutantcat/dsh-user-approval'
  ...
  constructor(ctx: Context, config: Config) {
    ...
    ctx.inject(['commands'], (commandCtx) => {
      commandCtx.commands.register({
        definitionId: CommandDefinitionId('@mutantcat/dsh-permission-presets'),
        name: 'permission',
