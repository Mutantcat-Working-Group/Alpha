...
import type { GenericCallView, ToolResult, WebFetchResultView } from '@mutantcat/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@mutantcat/dsh-web'
import { assertNever, type JsonValue } from '@mutantcat/dsh-util-values'
 ...
 * `@mutantcat/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@mutantcat/dsh-tool-call-timeout-policy` to enforce.
