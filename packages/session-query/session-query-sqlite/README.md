...
- name: '@mutantcat/dsh-session-query-sqlite'
  config:
...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-session-query-sqlite) is the exhaustive source for every accepted field and its JSDoc.
