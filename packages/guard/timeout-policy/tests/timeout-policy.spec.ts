/**
 * Unit + real-load-path coverage for @mutantcat/dsh-tool-call-timeout-policy. The
...
import { ToolCallId, HarnessError } from '@mutantcat/dsh-llm'
import SystemPrompt from '@mutantcat/dsh-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@mutantcat/dsh-tools'
import * as timeoutPolicy from '@mutantcat/dsh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@mutantcat/dsh-tool-call-timeout-policy'
