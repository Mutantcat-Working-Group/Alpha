...
import type {} from '@mutantcat/dsh-client-modules/client'
...
import type {} from '@mutantcat/dsh-client-ui-agent-preset/client'
// Inline-safe shared fold: shipped ids map to dictionary keys in one home.
import { presetDisplayText } from '@mutantcat/dsh-agent-presets/display'
