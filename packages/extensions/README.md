...
- [Generated tool catalog](../../docs/tool-catalog.md#mutantcatdsh-tool-cordis) — the two read-only tool schemas.
- [Generated configuration catalog](../../docs/config-catalog.md#mutantcatdsh-cordis-host-runner) — the runner's accepted config fields.
