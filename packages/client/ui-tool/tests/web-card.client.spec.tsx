...
import type { RunningToolCall, ToolResultNode } from '@mutantcat/dsh-client-ui-chat/client'
import type { ToolCallOwnerProps } from '@mutantcat/dsh-client-ui-tool/client'
...
import { zh } from '@mutantcat/dsh-client-ui-conversation/src/client/locales.ts'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@mutantcat/cordis').Context
