...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-mcp-client) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-mcp-client) — every accepted config field and its source declaration.
