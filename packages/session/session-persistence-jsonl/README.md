...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-session-persistence-jsonl) is the exhaustive source for every accepted field and its JSDoc.
