...
import AgentRegistry, { assembleContextFor } from '@mutantcat/dsh-agent'
import AgentLoop from '@mutantcat/dsh-agent-loop'
import InvariantRegistry from '@mutantcat/dsh-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@mutantcat/dsh-agent-presets'
import * as AgentPresetsInvariant from '@mutantcat/dsh-agent-presets/invariant'
