...
import { Context, FiberState, type Fiber } from '@mutantcat/cordis'
import { afterEach, describe, expect, it, vi } from 'vitest'
import { renderIndexInjections, type WebServer, type WebRoute } from '@mutantcat/dsh-host-webserver'
...
const MODULES_ID = '@mutantcat/dsh-client-modules'
const UI_RENDERER_ID = '@mutantcat/dsh-client-ui-renderer'
...
describe('module graph order', () => {
  ...
  it('leaves a request no row answers to the static assembly channel', () => {
    expect(ids(orderByModuleGraph([
      entry('consumer', { external: ['@mutantcat/cordis'] }),
      entry('other'),
