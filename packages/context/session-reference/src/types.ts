 ...
 * @module @mutantcat/dsh-session-reference/types
 */

import type { UserMessage } from '@mutantcat/dsh-llm/message'
import type { ContentBlock } from '@mutantcat/dsh-llm/types'
import type { OptionalSessionSeq, SessionId } from '@mutantcat/dsh-session/types'
