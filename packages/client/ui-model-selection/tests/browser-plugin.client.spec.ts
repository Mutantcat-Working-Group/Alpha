...
import { createScope } from '@mutantcat/dsh-api-session-controller/client'
...
import type { ModelSelection, ModelSelectionProjection } from '@mutantcat/dsh-api-session-controller/types'
import type { CommandContribution, PopupSelectSpec, SelectOption } from '@mutantcat/dsh-client-ui-commands/client'
