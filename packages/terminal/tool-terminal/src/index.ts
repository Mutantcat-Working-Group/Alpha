 ...
 * @module @mutantcat/dsh-tool-terminal
 */
...
import { TerminalSessionId } from '@mutantcat/dsh-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@mutantcat/dsh-terminal'
import type {} from '@mutantcat/dsh-jobs'
import { defineTool } from '@mutantcat/dsh-tools'
import type { ToolDefinition } from '@mutantcat/dsh-tools'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @mutantcat/dsh-jobs and @mutantcat/dsh-tool-jobs')
