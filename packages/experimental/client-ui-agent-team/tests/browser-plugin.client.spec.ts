...
import type { TeamMemberView as TeamRosterMember, TeamTaskId } from '@mutantcat/dsh-experimental-agent-team/client'
...
const REMOTE: TypertRemoteContribution = {
  package: '@mutantcat/dsh-experimental-agent-team',
  descriptors: [],
}
