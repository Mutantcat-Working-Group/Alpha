 ...
 *
 * @module @mutantcat/dsh-system-prompt
 */

import { Context, Service } from '@mutantcat/cordis'
import z from '@mutantcat/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@mutantcat/dsh-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@mutantcat/dsh-scope'
import type { ContextSnapshotSection, ToolSchema } from '@mutantcat/dsh-llm'
...
declare module '@mutantcat/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@mutantcat/dsh-scope`): scoped listeners
