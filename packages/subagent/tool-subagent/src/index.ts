 ...
 * @module @mutantcat/dsh-tool-subagent
 */

import type { Context } from '@mutantcat/cordis'
import z from '@mutantcat/schemastery'
import { scopeChainOf, scopeOf } from '@mutantcat/dsh-scope'
...
import type { SubagentProvider, SubagentResult, SubagentRun } from '@mutantcat/dsh-subagent'
import type { JobOutcome } from '@mutantcat/dsh-jobs'
import {
...
export function apply(ctx: Context, config: Config, session?: Session): void {
  ...
  if (settings === undefined) {
    throw new Error(
      ...
      + '@mutantcat/dsh-tool-subagent/model-selection-settings in the Host scope',
    )
  }
