...
import type { SessionRetainInfo } from '@mutantcat/dsh-api-session-controller/client'
...
describe('a refused switch', () => {
  it('announces the reason instead of letting the label snap back in silence', async () => {
    ...
    try {
      const reason = 'failed to import loader entry live-on-mac (@mutantcat/dsh-also-gone)'
