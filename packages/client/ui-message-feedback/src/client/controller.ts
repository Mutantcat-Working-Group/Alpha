 ...
 * @module @mutantcat/dsh-client-ui-message-feedback/client/controller
 */

import type { HostObservable } from '@mutantcat/dsh-client-ui-slots'
import type { ClientRemote, MessageId } from '@mutantcat/dsh-api-remotes/client'
...
} from '@mutantcat/dsh-message-feedback/types'
