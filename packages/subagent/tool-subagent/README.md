...
```yaml
- name: '@mutantcat/dsh-subagent'
- name: '@mutantcat/dsh-subagent-spawn-in-process'
...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-tool-subagent) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#mutantcatdsh-tool-subagent) — the default schema and per-mode wording.
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-tool-subagent) — every accepted config field.
