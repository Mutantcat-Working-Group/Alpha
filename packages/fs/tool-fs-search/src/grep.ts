 ...
 *
 * @module @mutantcat/dsh-tool-fs-search/grep
 */

import type { Context } from '@mutantcat/cordis'
import { defineTool } from '@mutantcat/dsh-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@mutantcat/dsh-tools'
import type { RetainedItems } from '@mutantcat/dsh-output-retention'
import type { SpillRef } from '@mutantcat/dsh-spill'
