...
The public package family belongs to the `@mutantcat` scope and uses the `node-addon-system` package prefix; platform packages append platform information only:

```text
@mutantcat/node-addon-system
@mutantcat/node-addon-system-<platform>
```
