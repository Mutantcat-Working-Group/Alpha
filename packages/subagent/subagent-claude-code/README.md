...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-subagent-claude-code) — every accepted config field and its source declaration.
