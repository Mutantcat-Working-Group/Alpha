 ...
 * companion beside `@mutantcat/dsh-invariants` to enable the checks.
 *
 * @module @mutantcat/dsh-session/invariant
 */
...
import type { Session, SessionEvent, SessionSeqCursor } from '@mutantcat/dsh-session'
import { assertNever } from '@mutantcat/dsh-util-values'
import { TOOL_NOT_STARTED } from './repair.ts'

const PACKAGE_NAME = '@mutantcat/dsh-session'
