...
describe('replaced external packages', () => {
  ...
  it('lists the packages the loader serves from the bundle', () => {
    ...
    expect(REPLACED_EXTERNAL_PACKAGES).not.toContain('@mutantcat/node-addon-system')
    expect(REPLACED_EXTERNAL_PACKAGES).not.toContain('@mutantcat/node-addon-system/landlock-run')
