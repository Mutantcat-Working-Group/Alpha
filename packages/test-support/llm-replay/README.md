...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-llm-replay) is the exhaustive source for every accepted field and its JSDoc.
