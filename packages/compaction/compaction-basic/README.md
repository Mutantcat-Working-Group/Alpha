...
- name: '@mutantcat/dsh-token-meter'
- name: '@mutantcat/dsh-compaction-tool-result-pruner'
- name: '@mutantcat/dsh-compaction-basic'
- name: '@mutantcat/dsh-command-compact'
```
...
All settings are optional. The defaults start condensing at 80% of the routed model's context window and keep the newest 16% verbatim; the table below is the complete policy surface, and the generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-compaction-basic) is the exhaustive source.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-compaction-basic) — every accepted config field and its source declaration.
