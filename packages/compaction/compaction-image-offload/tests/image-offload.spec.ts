...
import { ImageVariantId } from '@mutantcat/dsh-attachment'
import { serializeRequestWithImages } from '@mutantcat/dsh-llm-deepseek/src/protocols/chat-completions/serialize.ts'
import { mountAgentLoopTestDependencies } from '@mutantcat/dsh-agent-loop-testkit'
import { createAssistantMessage, createToolResultMessage, createUserMessage, IMAGE_OFFLOAD_REQUIRED_CODE, LlmAdapter, LlmError, ToolCallId } from '@mutantcat/dsh-llm'
import type { ContentBlock, GenerateOptions, StreamChunk } from '@mutantcat/dsh-llm'
import { isReplacementSurfaceEvent, SessionId } from '@mutantcat/dsh-session'
