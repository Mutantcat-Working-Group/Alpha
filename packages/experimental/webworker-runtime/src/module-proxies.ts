 ...
 * @module @mutantcat/dsh-experimental-webworker-runtime/src/module-proxies
 */
...
export const MODULE_PROXIES: Record<string, string> = {
  ...
  '@mutantcat/node-addon-system/flock': './node/external_packages/node-addon-system-flock.ts',
