...
import { isCompactCheckpointSource } from '@mutantcat/dsh-compaction'
import type { SessionSurfaceSnapshot } from '@mutantcat/dsh-session-query'
...
import type { OptionalSessionSeq, SessionId } from '@mutantcat/dsh-session'
