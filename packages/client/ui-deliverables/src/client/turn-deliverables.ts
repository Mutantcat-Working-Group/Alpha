 ...
 */
import { isAppendSurfaceEvent } from '@mutantcat/dsh-session/surface'
import type { TurnTailOwnerProps } from '@mutantcat/dsh-client-ui-chat/client'
import type { ConversationNodeDefinition } from '@mutantcat/dsh-client-ui-conversation/client'
import type { MarkdownFileMentions } from '@mutantcat/dsh-client-ui-primitives'
import type { PresentedFile } from '@mutantcat/dsh-tool-present/types'
