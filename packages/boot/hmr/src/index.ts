...
import { Context, Inject, Service, type Plugin } from '@mutantcat/cordis'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@mutantcat/cordis-plugin-loader'
import type { Include } from '@mutantcat/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { basename, dirname, join, relative, resolve } from 'node:path'
import { readFileSync, realpathSync } from 'node:fs'
import { readProfileManifest, readProfilePatches, reconcileProfilePatches, PROFILE_PATCH_FILENAME } from '@mutantcat/dsh-app-boot'
import type {} from '@mutantcat/dsh-cmdline'
import { handleError } from './error.ts'
import type {} from '@mutantcat/cordis-plugin-timer'
