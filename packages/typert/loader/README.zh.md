...
生成的[配置目录](../../../docs/config-catalog.zh.md#mutantcatdsh-typert-loader)是所有受支持字段的完整真源。
...
- [生成配置目录](../../../docs/config-catalog.zh.md#mutantcatdsh-typert-loader)——`packages` 字段声明及其 JSDoc。
