...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-subagent-dsh-sdk) is the exhaustive source for every accepted field and its JSDoc.
...
```yaml
- id: subagent-dsh-sdk
  name: '@mutantcat/dsh-subagent-dsh-sdk'
  config:
...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-subagent-dsh-sdk) — every accepted config field and its source declaration.
