...
import WebRuntime, { WebError } from '@mutantcat/dsh-web'
import {
  DeepSeekSearchProvider,
  DEEPSEEK_PROVIDER_ID,
} from '@mutantcat/dsh-web-search-deepseek'
...
import type { AnthropicResponse } from '@mutantcat/dsh-web-search-deepseek/src/types.ts'

/** Construct the provider over a fixed options value; production passes a live thunk. */
import type { DeepSeekSearchProviderOptions } from '@mutantcat/dsh-web-search-deepseek'
