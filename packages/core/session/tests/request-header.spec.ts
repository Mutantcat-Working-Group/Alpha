...
import { Session, SessionId, SessionSeq, canonicalHeader, foldRequestHeader, headerEquals } from '@mutantcat/dsh-session'
import type { EpochHeader, SessionEvent } from '@mutantcat/dsh-session'
