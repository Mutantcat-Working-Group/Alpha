...
const { LlmAdapter, createUserMessage } = await import(pathToFileURL(require.resolve('@mutantcat/dsh-llm')).href)
const observed = []
const { runProfile } = await import(pathToFileURL(require.resolve('@mutantcat/dsh/profile-boot')).href)
const { loadLayeredEnv, loadProfileDirectory } = await import(pathToFileURL(require.resolve('@mutantcat/dsh-app-boot')).href)
const installAnchor = require.resolve('@mutantcat/dsh/package.json')
