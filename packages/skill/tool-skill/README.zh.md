...
生成的[配置目录](../../../docs/config-catalog.zh.md#mutantcatdsh-tool-skill)是每个受支持字段的穷尽式真源。
...
- [生成工具目录](../../../docs/tool-catalog.zh.md#mutantcatdsh-tool-skill)——模型接收的精确 `skill` schema。
...
模型会看到生成的 [`skill` schema](../../../docs/tool-catalog.zh.md#mutantcatdsh-tool-skill)。
