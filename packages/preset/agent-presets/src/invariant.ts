/**
 * Package-owned invariant companion for `@mutantcat/dsh-agent-presets`.
 * @module @mutantcat/dsh-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@mutantcat/dsh-agent-presets'

const PACKAGE_NAME = '@mutantcat/dsh-agent-presets'
