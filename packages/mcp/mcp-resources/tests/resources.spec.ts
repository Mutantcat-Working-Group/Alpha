...
import ToolRuntime, { defineTool, type Config as ToolConfig } from '@mutantcat/dsh-tools'
import { ToolCallId } from '@mutantcat/dsh-llm'
import type { Agent } from '@mutantcat/dsh-agent'
import { bindScopeParent, createScope, type Scope } from '@mutantcat/dsh-scope'
import { PtcRuntime, type PtcRunRequest, type PtcRunResult, type PtcRunSpec } from '@mutantcat/dsh-ptc-runtime'
