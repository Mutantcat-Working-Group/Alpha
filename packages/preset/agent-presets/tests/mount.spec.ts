...
import { PluginPackages } from '@mutantcat/dsh-app-boot'
...
import AgentRegistry, { assembleContextFor, type Agent } from '@mutantcat/dsh-agent'
...
} from '@mutantcat/dsh-agent-presets'
