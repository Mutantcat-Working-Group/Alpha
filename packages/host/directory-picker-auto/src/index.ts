 ...
 * @module @mutantcat/dsh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@mutantcat/dsh-host-directory-picker-native',
  browse: '@mutantcat/dsh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@mutantcat/dsh-client-ui-directory-picker-native',
  browse: '@mutantcat/dsh-client-ui-directory-picker-browse',
}
