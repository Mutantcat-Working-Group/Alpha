 ...
 * @module @mutantcat/dsh-tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@mutantcat/cordis'
import { AttachmentError, AttachmentId } from '@mutantcat/dsh-attachment'
import type { AttachmentStore, ImageAttachmentRef, ImageMediaType } from '@mutantcat/dsh-attachment'
import type { ContentBlock } from '@mutantcat/dsh-llm'
import { defineTool } from '@mutantcat/dsh-tools'
import type { GenericCallView, ToolExecution } from '@mutantcat/dsh-tools'
