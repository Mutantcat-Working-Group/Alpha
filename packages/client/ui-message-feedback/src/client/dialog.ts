 ...
 * @module @mutantcat/dsh-client-ui-message-feedback/client/dialog
 */

import { createSnapshotStore, type SnapshotStore } from '@mutantcat/dsh-client-store'
import type { MessageId } from '@mutantcat/dsh-api-remotes/client'
import type { FeedbackCategory, FeedbackRecord } from '@mutantcat/dsh-command-feedback/types'
import type { MessageFeedbackRating } from '@mutantcat/dsh-message-feedback/types'
