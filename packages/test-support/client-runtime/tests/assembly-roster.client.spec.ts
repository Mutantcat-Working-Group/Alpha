...
import { createClientModuleSystem, parseBootManifest, type ClientBundleRegistration, type ClientModuleLoaderTarget } from '@mutantcat/dsh-client-modules/client'
...
describe('ClientRoster', () => {
  ...
  it('closure treats the platform seed modules as satisfied without a row', () => {
    const seeded = { name: 'seeded', inject: ['@mutantcat/dsh-client-ui-primitives', 'react', 'a'], immediately: false }
