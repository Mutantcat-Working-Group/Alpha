...
import { bindScopeParent, carrierKeyOf, createScope, isScopeCarrier, scopeChainOf, scopeOf, scopeParentOf, scopeTarget } from '@mutantcat/dsh-scope'
import type { Scope, Scoped } from '@mutantcat/dsh-scope'
