...
```yaml
- name: '@mutantcat/dsh-file-reference-local'
  config:
    maxResults: 20
```
...
- [Filesystem tool catalog](../../../docs/tool-catalog.md#mutantcatdsh-tool-fs) — the `read` tool whose namespace discovery must match.
