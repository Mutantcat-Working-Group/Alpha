...
```yaml
- name: '@mutantcat/dsh-fs-local'
- name: '@mutantcat/dsh-fs-observation-policy'
- name: '@mutantcat/dsh-tool-fs'
```
...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-tool-fs) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#mutantcatdsh-tool-fs) — the exhaustive schemas this package registers.
