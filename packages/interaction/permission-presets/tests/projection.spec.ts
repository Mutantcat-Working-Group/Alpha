...
import PermissionPresetService from '@mutantcat/dsh-permission-presets'
import { AUTO_PRESET } from '@mutantcat/dsh-permission-presets'
import type { Config } from '@mutantcat/dsh-permission-presets'
