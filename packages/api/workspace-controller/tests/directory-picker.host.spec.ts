...
import { DirectoryPicker, DirectoryPickerError } from '@mutantcat/dsh-host-directory-picker'
import type { DirectoryPickerCapability } from '@mutantcat/dsh-host-directory-picker'
