/** Package-owned compaction log-stream invariants. @module @mutantcat/dsh-compaction/invariant */

import type { Context } from '@mutantcat/cordis'
import { isReplacementSurfaceEvent, SessionSeq } from '@mutantcat/dsh-session'
...
const PACKAGE_NAME = '@mutantcat/dsh-compaction'
