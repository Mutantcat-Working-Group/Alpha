...
import { WorkspaceFiles } from '@mutantcat/dsh-api-workspace-files'
...
import type { SessionEventReadRequest } from '@mutantcat/dsh-session-query'
import type { WorkspaceChangedFile, WorkspaceChangesSummary, WorkspaceFileDiff } from '@mutantcat/dsh-workspace-changes/types'
