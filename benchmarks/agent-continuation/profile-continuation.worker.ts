...
async function run(root: string): Promise<ProfileReport> {
  ...
  await writeFile(patch, [
    ...
    '- insert:',
    '    - id: fs-local', "      name: '@mutantcat/dsh-fs-local'",
    '    - id: str-replace-editor', "      name: '@mutantcat/dsh-tool-str-replace-editor'",
...
assertBuiltBenchmarkRuntime(import.meta.url, { '@mutantcat/dsh-sdk-client': import.meta.resolve('@mutantcat/dsh-sdk-client') })
