 ...
 *
 * @module @mutantcat/dsh-file-reference-local
 */
...
} from '@mutantcat/dsh-file-reference'
...
export { FILE_REFERENCE_PROMPT } from '@mutantcat/dsh-file-reference'
export { activeAtToken, formatFileMention } from '@mutantcat/dsh-file-reference/grammar'
