/**
 * Package-owned invariant companion for `@mutantcat/dsh-tool-subagent`.
 * @module @mutantcat/dsh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@mutantcat/dsh-tool-subagent'
