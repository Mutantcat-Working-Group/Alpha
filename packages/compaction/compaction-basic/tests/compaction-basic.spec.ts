...
import BasicCompactionEngine from '@mutantcat/dsh-compaction-basic'
import type { BasicCompactionConfig } from '@mutantcat/dsh-compaction-basic'
import { selectCompactableRange } from '@mutantcat/dsh-compaction-basic/src/region.ts'
import { frameSummary } from '@mutantcat/dsh-compaction-basic/src/summarizer.ts'
import type { SummarizationInput, SummaryResult } from '@mutantcat/dsh-compaction-basic/src/summarizer.ts'
import { CompactionId, toolPairingBalancedAfter, toolPairingBalancedBefore } from '@mutantcat/dsh-compaction'
import {
  resolveCompactSpec,
  resolveConfig,
  resolveTargetPolicy,
} from '@mutantcat/dsh-compaction-basic/src/config.ts'
import type { CompactionResult } from '@mutantcat/dsh-compaction'
import LlmRuntime, { createUserMessage, ToolCallId, CONTEXT_WINDOW_EXCEEDED_CODE, createSystemMessage, createToolResultMessage, LlmAdapter , createMessage } from '@mutantcat/dsh-llm'
import type {
  ContentBlock,
  GenerateOptions,
  LlmFailure,
...
import { agentEvents, type Agent, type RequestErrorAction } from '@mutantcat/dsh-agent'
import ToolResultPruner from '@mutantcat/dsh-compaction-tool-result-pruner'
...
const SYSTEM_PROMPT_PLUGIN = '@mutantcat/dsh-system-prompt'
