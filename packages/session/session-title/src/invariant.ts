/**
 * Package-owned invariant companion for `@mutantcat/dsh-session-title`.
 * @module @mutantcat/dsh-session-title/invariant
 */
...
const PACKAGE_NAME = '@mutantcat/dsh-session-title'
