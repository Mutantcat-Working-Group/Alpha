...
import type { PtcBindingFunction, PtcRunRequest, PtcRunResult, PtcRunSpec } from '@mutantcat/dsh-ptc-runtime'
...
import type { SubagentResult } from '@mutantcat/dsh-subagent'
