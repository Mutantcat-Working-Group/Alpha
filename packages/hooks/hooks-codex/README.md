...
```yaml
- name: '@mutantcat/dsh-hooks-codex'
  config:
...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-hooks-codex) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-hooks-codex) — every accepted config field and its source declaration.
