...
import type { TypertRemoteNamespace, TypertRemoteNamespaceMap } from '@mutantcat/dsh-typert-protocol'
import type {} from '@mutantcat/dsh-api-settings-controller/remote'
...
function compile(source: string, artifact?: string) {
  ...
  const options: ts.CompilerOptions = {
    ...
    types: ['node'],
    paths: {
      '@mutantcat/cordis': [cordisEntry],
      '@mutantcat/dsh-typert-protocol': [protocolEntry],
      '@mutantcat/fixture/remote': [artifactPath],
    },
  }
...
describe('RemoteMock proxy types', { timeout: 60_000 }, () => {
  it('keeps production closed while an empty generated map permits Mock calls and overrides', () => {
    compile(`
import type { TypertRemoteNamespace, TypertClientRemote } from '@mutantcat/dsh-typert-protocol'
...
`)
  ...
  it('preserves generated arguments, results and native spy overrides', () => {
    compile(`
import type { MockedRemote } from '../src/remote-proxy.ts'
import type {} from '@mutantcat/fixture/remote'
type IsAny<T> = 0 extends (1 & T) ? true : false
declare const local: MockedRemote
...
`, fixtureDeclaration)
  ...
  it('keeps partial and empty namespaces closed inside a non-empty map', () => {
    compile(`
import type { TypertClientRemote, TypertRemoteNamespace } from '@mutantcat/dsh-typert-protocol'
import type { MockedRemote } from '../src/remote-proxy.ts'
import type {} from '@mutantcat/fixture/remote'
...
`, fixtureDeclaration)
  ...
  it('retains the native/generated type dependencies only in the proxy declaration', () => {
    ...
    expect(runtime.outputText).not.toContain('@mutantcat/dsh-typert-protocol')
...
import type { TypertRemoteNamespace } from '@mutantcat/dsh-typert-protocol'
