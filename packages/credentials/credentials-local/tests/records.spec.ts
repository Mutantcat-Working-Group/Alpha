...
import { credentialKey, credentialKeyScope, credentialRef, parseCredentialKey } from '@mutantcat/dsh-credentials'
import type { CredentialKey, CredentialRecord } from '@mutantcat/dsh-credentials'
