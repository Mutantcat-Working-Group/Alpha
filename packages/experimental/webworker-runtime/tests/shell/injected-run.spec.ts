...
import { filesystemError } from '@mutantcat/dsh-experimental-webworker-runtime/src/shell/fs-access.ts'
import type {
  ShellDirent, ShellFileSystem, ShellRunOutcome, ShellStats,
} from '@mutantcat/dsh-experimental-webworker-runtime/src/shell/types.ts'
