...
- Build all three platforms on one pipeline, with the signing strategy stated per target instead of discovered from certificates.
...
### 7. Build from source and packaging
