...
export const zh = {
  ...
  installSpecPlaceholder: '例如 @mutantcat/dsh-experimental-auto-review',
  ...
  installGuideIdExample: '@mutantcat/dsh-experimental-auto-review',
...
export const en = {
  ...
  installSpecPlaceholder: 'for example @mutantcat/dsh-experimental-auto-review',
