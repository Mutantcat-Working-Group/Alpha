/**
 * Package-owned invariant companion for `@mutantcat/dsh-authorization`.
 * @module @mutantcat/dsh-authorization/invariant
 */

import type { Context } from '@mutantcat/cordis'
import type { InvariantFailure, InvariantInstaller } from '@mutantcat/dsh-invariants'

const PACKAGE_NAME = '@mutantcat/dsh-authorization'
