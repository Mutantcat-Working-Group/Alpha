/** Local durable attachment backend rooted below `DSH_HOME`. @module @mutantcat/dsh-attachment-local */
...
import { dshCachePath, resolveDshHome } from '@mutantcat/dsh-home-paths'
