 ...
 *
 * @module @mutantcat/dsh-api-session-controller/client/sessions/remotes
 */

import type { ClientRemote } from '@mutantcat/dsh-api-gateway/client'
import type { CommandSubmitAttachment } from '@mutantcat/dsh-commands/types'
...
} from '@mutantcat/dsh-subagent/client'
