...
import type { ILayout, MainPanelId } from '@mutantcat/dsh-client-ui-layout/client'
import type { PropsRenderSlots, PropsRuntime, SlotLabel } from '@mutantcat/dsh-client-ui-slots'
