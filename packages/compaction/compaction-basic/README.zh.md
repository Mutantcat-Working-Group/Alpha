...
所有设置都可选。默认在已路由模型上下文窗口的 80% 处开始压缩，并逐字保留最新的 16%；下表是完整的策略面，生成的[配置目录](../../../docs/config-catalog.zh.md#mutantcatdsh-compaction-basic)是穷尽式真源。
...
- [生成配置目录](../../../docs/config-catalog.zh.md#mutantcatdsh-compaction-basic)——每个受支持配置字段及其源声明。
