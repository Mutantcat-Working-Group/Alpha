 ...
 * @module @mutantcat/dsh-agent-presets/mount
 */

import { pathToFileURL } from 'node:url'
import { Context, type Fiber } from '@mutantcat/cordis'
import { Include } from '@mutantcat/cordis-plugin-include'
import type { EntryTree } from '@mutantcat/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@mutantcat/dsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@mutantcat/dsh-*` row would fail to import. The
