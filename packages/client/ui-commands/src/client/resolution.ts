...
import type { CommandDescriptor } from '@mutantcat/dsh-commands/types'
import type { TranslateNS } from '@mutantcat/dsh-client-locale/client'
import { en, zh } from './locales.ts'

const BUILTINS = {
  goal: '@mutantcat/dsh-command-goal',
  plan: '@mutantcat/dsh-plan-mode',
  feedback: '@mutantcat/dsh-command-feedback',
  compact: '@mutantcat/dsh-command-compact',
  permission: '@mutantcat/dsh-permission-presets',
  export: '@mutantcat/dsh-session-log-export',
} as const
