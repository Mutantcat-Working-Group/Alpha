...
import { seatbeltProfileArgs } from '@mutantcat/dsh-sandbox-local/src/profiles.ts'
 ...
 * confinement is covered by `@mutantcat/dsh-sandbox-local`. Skips off macOS or when
