...
import { DUNDER_MEMBER, PORTABLE_RESERVED_WORDS, RESERVED_BINDING_GLOBALS, RESERVED_ERROR_MEMBERS } from '@mutantcat/dsh-ptc-runtime'
import type { PtcBindingNamespace, PtcRunRequest } from '@mutantcat/dsh-ptc-runtime'
