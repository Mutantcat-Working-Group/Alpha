...
import type { WebTerminalId, WebTerminalInfo } from '@mutantcat/dsh-api-terminal-controller/types'
import { SidebarRightTabRegistry } from '@mutantcat/dsh-client-ui-sidebar-right/src/client/tab-registry.ts'
import type { SidebarRightCloseHandler } from '@mutantcat/dsh-client-ui-sidebar-right/client'
import type { SidebarRightOpenTab } from '@mutantcat/dsh-client-ui-sidebar-right/client'
