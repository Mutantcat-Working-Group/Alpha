...
- name: '@mutantcat/dsh-tool-subagent-control'
- name: '@mutantcat/dsh-tool-subagent-control/list-agents'
```
...
- [Generated tool catalog](../../../docs/tool-catalog.md#mutantcatdsh-tool-subagent-control) — the three tool schemas.
...
The generated [schemas](../../../docs/tool-catalog.md#mutantcatdsh-tool-subagent-control): `send_message` takes `agent_id` and `message`; `interrupt_agent` takes `agent_id`; `list_agents` takes the optional `scope` enum.
