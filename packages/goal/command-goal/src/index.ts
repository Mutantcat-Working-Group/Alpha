 ...
 * @module @mutantcat/dsh-command-goal
 */

import type { Context } from '@mutantcat/cordis'
import { CommandDefinitionId } from '@mutantcat/dsh-commands/brand'
import type { CommandInvocation, CommandResult } from '@mutantcat/dsh-commands'
import { GoalError } from '@mutantcat/dsh-goal'
import type { GoalPhase, GoalRef, GoalView } from '@mutantcat/dsh-goal'
...
export function apply(ctx: Context): void {
  ctx.commands.register({
    definitionId: CommandDefinitionId('@mutantcat/dsh-command-goal'),
    name: 'goal',
