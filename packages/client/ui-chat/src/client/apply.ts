...
import type { SessionBinding } from '@mutantcat/dsh-api-session-controller/client'
...
import type {} from '@mutantcat/dsh-client-ui-sidebar-browser/client'
import type {} from '@mutantcat/dsh-client-ui-input-trigger/client'
// The `file` entry of `SidebarRightResourceParamsMap`, which types `{ params: { line } }` below.
import type {} from '@mutantcat/dsh-client-ui-sidebar-documentpreview/client'
import { fileAddressFor } from '@mutantcat/dsh-util-workspace-path'
