 ...
 * `@mutantcat/dsh-tool-subagent` instances so multiple delegation tools share
 * one control API.
 * @module @mutantcat/dsh-tool-subagent-control
 */
...
import { markAdjacentAgentSendMessageTool } from '@mutantcat/dsh-subagent/internal'
