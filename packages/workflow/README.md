...
- [Generated tool catalog](../../docs/tool-catalog.md#mutantcatdsh-tool-workflow) — the `workflow` tool schema the model receives.
- [Generated tool catalog](../../docs/tool-catalog.md#mutantcatdsh-tool-ralph) — the `ralph` tool schema the model receives.
- [Generated configuration catalog](../../docs/config-catalog.md#mutantcatdsh-workflow-ptc) — every accepted engine config field.
