...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-sandbox-policy) is the exhaustive source for every accepted field and its JSDoc.
