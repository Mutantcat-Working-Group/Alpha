...
import { MemoryVfs } from '@mutantcat/dsh-experimental-webworker-runtime/src/storage/memory.ts'
import { setActiveVfs } from '@mutantcat/dsh-experimental-webworker-runtime/src/storage/active.ts'
import { spawn, spawnSync } from '@mutantcat/dsh-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process.ts'
import {
  LAUNCHER_FAILURE_EXIT, grantArgs, launcherPath, probe,
} from '@mutantcat/node-addon-system/landlock-run'
import { processAlive, signalProcess } from '@mutantcat/dsh-experimental-webworker-runtime/src/node/process-table.ts'
import { hostFileSystem } from '@mutantcat/dsh-experimental-webworker-runtime/src/shell/fs-access.ts'
import {
  LANDLOCK_EXECUTABLE, landlockFileSystem, parseLandlockArguments,
} from '@mutantcat/dsh-experimental-webworker-runtime/src/shell/process/landlock.ts'
import { spawnSubprocess } from '@mutantcat/dsh-subprocess-local/src/spawn.ts'

vi.mock('node:child_process', async () =>
  await import('@mutantcat/dsh-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process.ts'))
