...
```yaml
- name: '@mutantcat/dsh-time-context'
  config:
...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-time-context) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-time-context) — every accepted config field and its source declaration.
