...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-session-telemetry-otel) — every accepted config field and its source declaration.
