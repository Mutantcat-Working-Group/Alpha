/**
 * Package-owned invariant companion for `@mutantcat/dsh-storage-domain`: every
 ...
 * @module @mutantcat/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@mutantcat/dsh-storage-domain'
