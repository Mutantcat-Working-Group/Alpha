...
```yaml
- name: '@mutantcat/dsh-agent-instructions'
  config:
    maxBytes: 65536
```
...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-agent-instructions) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-agent-instructions) — every accepted config field and its source declaration.
