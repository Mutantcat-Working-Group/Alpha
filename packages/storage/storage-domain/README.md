...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-storage-domain) is the exhaustive source for every accepted field and its JSDoc.
