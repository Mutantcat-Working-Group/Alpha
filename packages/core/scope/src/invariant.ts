/** Package-owned scoped-dispatch invariants. @module @mutantcat/dsh-scope/invariant */

import type { Context } from '@mutantcat/cordis'
import type { InvariantInstaller } from '@mutantcat/dsh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@mutantcat/dsh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@mutantcat/dsh-scope'
