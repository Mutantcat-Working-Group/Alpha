 ...
 * mirror of `@mutantcat/dsh-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @mutantcat/dsh-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@mutantcat/dsh-shell'
import type { RunnerFailureRule } from '@mutantcat/dsh-sandbox'
