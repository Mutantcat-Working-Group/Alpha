...
import LlmRuntime, { createUserMessage, ToolCallId, HarnessError  } from '@mutantcat/dsh-llm'
...
import type { ToolExecutionResult } from '@mutantcat/dsh-tools'
...
import NodeRuntime from '@mutantcat/dsh-ptc-runtime-node'
