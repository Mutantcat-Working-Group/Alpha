...
import { createNodeBuiltins, REPLACED_PREFIXES } from '@mutantcat/dsh-experimental-webworker-runtime/src/node/builtins.ts'
import {
  setActiveModuleLoader, WorkerModuleLoader,
} from '@mutantcat/dsh-experimental-webworker-runtime/src/module-system/module-loader.ts'
import { inflateImage } from '@mutantcat/dsh-experimental-webworker-runtime/src/storage/image-gzip.ts'
import { loadVfsImage } from '@mutantcat/dsh-experimental-webworker-runtime/src/storage/memory.ts'
...
const SUBJECT = '@mutantcat/dsh-timeout'
const LANDLOCK = '@mutantcat/node-addon-system'
const LANDLOCK_ENTRY = `${LANDLOCK}/landlock-run`
const PLUGIN_INVENTORY = '@mutantcat/dsh-plugin-package-inventory-deepseek'
const WEB_SERVER = '@mutantcat/dsh-host-webserver'
