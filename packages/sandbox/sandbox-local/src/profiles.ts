 ...
 *
 * @module @mutantcat/dsh-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@mutantcat/node-addon-system/landlock-run'
 ...
 * (`@mutantcat/dsh-fs-sandbox`) can never drift apart.
