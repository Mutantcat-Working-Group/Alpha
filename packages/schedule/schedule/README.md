...
- [Generated tool catalog](../../../docs/tool-catalog.md#mutantcatdsh-schedule) — the complete `schedule_create`, `schedule_list`, and `schedule_delete` schemas the model receives.
...
The model sees the three generated tool schemas only in a live root Agent created after this plugin loads; the [generated tool catalog](../../../docs/tool-catalog.md#mutantcatdsh-schedule) owns the exact argument and result schemas. Tool results contain the canonical JSON values described above.
