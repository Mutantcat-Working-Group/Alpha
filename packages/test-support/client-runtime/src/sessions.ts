...
import type { AttachmentIdType } from '@mutantcat/dsh-attachment'
import {
...
import { scopeIdentityOf } from '@mutantcat/dsh-api-session-controller/src/client/scope.ts'
import type { SessionRequestId } from '@mutantcat/dsh-api-session-controller/types'
