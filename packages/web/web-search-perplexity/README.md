...
- name: '@mutantcat/dsh-web-search-perplexity'
  config:
...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-web-search-perplexity) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-web-search-perplexity) — every accepted config field and its source declaration.
