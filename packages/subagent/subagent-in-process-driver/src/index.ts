 ...
 * one result.
 *
 * @module @mutantcat/dsh-subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@mutantcat/cordis'
import { brandString } from '@mutantcat/dsh-brand'
import { foldConsumedWork } from '@mutantcat/dsh-agent'
import type { Agent, AgentHandle } from '@mutantcat/dsh-agent'
import { SessionLogOffset } from '@mutantcat/dsh-session'
import type { SessionEvent, SessionId, SessionLogOffset as SessionLogOffsetType, TurnEndReason } from '@mutantcat/dsh-session'
import { createUserMessage, type ContentBlock } from '@mutantcat/dsh-llm'
import {
