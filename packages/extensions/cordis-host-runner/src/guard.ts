 ...
 * @module @mutantcat/dsh-cordis-host-runner/guard
 */

import { Context } from '@mutantcat/cordis'
import type { Plugin } from '@mutantcat/cordis'
import { scopeOf } from '@mutantcat/dsh-scope'
import { assertSupportedJsonSchema, defineTool } from '@mutantcat/dsh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@mutantcat/dsh-cordis-client-runner`, whose CTX_VERBS names this one its
