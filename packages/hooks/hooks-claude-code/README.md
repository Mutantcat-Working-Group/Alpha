...
```yaml
- name: '@mutantcat/dsh-hooks-claude-code'
  config:
...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-hooks-claude-code) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-hooks-claude-code) — every accepted config field and its source declaration.
