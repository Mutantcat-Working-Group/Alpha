...
describe('scrubSessionSnapshot', () => {
  ...
  it('preserves the header while projecting and scrubbing each body record', () => {
    ...
    expect(scrubSessionSnapshot(`${header}\n${system}\n${request}\n${event}\n`)).toBe([
      header,
      '{"type":"system/message","data":{"turn":1,"step":1,"message":{"id":"11111111-1111-4111-8111-111111111111","role":"system","content":[{"type":"text","text":"{{system}}"}],"source":{"kind":"plugin","plugin":"@mutantcat/dsh-system-prompt"}}}}',
