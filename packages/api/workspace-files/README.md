...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-api-workspace-files) is the exhaustive source for every accepted field and its JSDoc.
