...
- name: '@mutantcat/dsh-tool-fs-search'
  config:
    sampleOverCapGlobResults: false
- name: '@mutantcat/dsh-spill-local'
```
...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-tool-fs-search) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#mutantcatdsh-tool-fs-search) — the exhaustive schemas this package registers.
...
The glob description states the configured over-cap ordering. The generated [`glob` and `grep` schemas](../../../docs/tool-catalog.md#mutantcatdsh-tool-fs-search) use `sampleOverCapGlobResults: true`; the tools are registered unconditionally.
