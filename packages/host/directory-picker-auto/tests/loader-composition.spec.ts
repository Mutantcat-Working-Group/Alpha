...
import HttpServer from '@mutantcat/dsh-host-webserver'
import type { DirectoryPicker } from '@mutantcat/dsh-host-directory-picker'
import BrowseDirectoryPicker from '@mutantcat/dsh-host-directory-picker-browse'
import NativeDirectoryPicker from '@mutantcat/dsh-host-directory-picker-native'
import {
  createLaunchEnvironmentSnapshot, DSH_LAUNCH_ENVIRONMENT_KEY, type LaunchEnvironmentSnapshot,
} from '@mutantcat/dsh-launch-environment'
...
const AUTO = '@mutantcat/dsh-host-directory-picker-auto'
const NATIVE = '@mutantcat/dsh-host-directory-picker-native'
const BROWSE = '@mutantcat/dsh-host-directory-picker-browse'
const NATIVE_SURFACE = '@mutantcat/dsh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@mutantcat/dsh-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  const modules = new Map<string, unknown>([
    ['@mutantcat/dsh-host-webserver', HttpServer],
