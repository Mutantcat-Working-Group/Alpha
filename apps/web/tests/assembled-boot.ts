...
import { bootInjections, orderByModuleGraph } from '@mutantcat/dsh-client-modules'
import type { ClientModuleLoaderTarget, WebBootEntry, WebBootGraph } from '@mutantcat/dsh-client-modules/client'
...
const appBoot = await import(pathToFileURL(webBundleResolver.resolve('@mutantcat/dsh-app-boot')).href) as unknown as BootComposition
...
const BOOTSTRAP_IDS = ['@mutantcat/dsh-client-modules'] as const
