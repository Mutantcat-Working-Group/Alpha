...
import { RemoteStreamCarrierError, type ClientRemote } from '@mutantcat/dsh-api-gateway/client'
import { SessionId } from '@mutantcat/dsh-session/types'
import { RemoteError } from '@mutantcat/dsh-typert-protocol'
import { frames, openStream, type RemoteMock, type StreamScript } from '@mutantcat/dsh-remote-mock'
...
const SELF = '@mutantcat/dsh-api-workspace-controller'
