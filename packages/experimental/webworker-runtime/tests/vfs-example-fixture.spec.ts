...
import { SESSION_FORMAT_VERSION, Session, SessionId, type SessionEvent } from '@mutantcat/dsh-session'
import {
  generationLogFilename,
  scanLog,
} from '@mutantcat/dsh-session-persistence-jsonl/src/format.ts'
import { foldSubagentDescriptor } from '@mutantcat/dsh-subagent'
import { projectionCacheDomainSpec } from '@mutantcat/dsh-session-projection-cache'
import {
