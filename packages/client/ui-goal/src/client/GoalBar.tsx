...
import type { GoalActivation, GoalSnapshot } from '@mutantcat/dsh-goal/client'
import {
...
import type { InjectFace, PropsLocale, TranslateNS } from '@mutantcat/dsh-client-ui-slots'
...
export type GoalDockProps =
  import('@mutantcat/dsh-client-ui-slots').PropsRuntime<'conversation.input.dock'>
