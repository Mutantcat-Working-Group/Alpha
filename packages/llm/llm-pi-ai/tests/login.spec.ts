...
import type { AuthorizationInteraction, AuthorizationNotice, AuthorizationPrompt } from '@mutantcat/dsh-authorization'
import LocalCredentialProvider from '@mutantcat/dsh-credentials-local'
import type { CredentialKey } from '@mutantcat/dsh-credentials'
