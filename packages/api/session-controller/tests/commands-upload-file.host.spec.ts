...
import AttachmentStore, { AttachmentId } from '@mutantcat/dsh-attachment'
import type {
...
import type { UserMessage } from '@mutantcat/dsh-llm'
...
import FileUploads from '@mutantcat/dsh-client-file-upload'
