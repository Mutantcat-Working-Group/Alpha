...
import { createLazyRequire } from '@mutantcat/dsh-lazy-require'
import {
  ...
  isNullPtr,
  throwLastError,
} from '@mutantcat/dsh-win32-process'
import type { NativePtr, Win32ProcessBindings } from '@mutantcat/dsh-win32-process'
...
export type { NativePtr } from '@mutantcat/dsh-win32-process'
