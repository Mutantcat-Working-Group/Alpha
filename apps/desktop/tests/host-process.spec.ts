...
function projectWithHost(source = HTTP_HOST): string {
  ...
  roots.push(project)
  const packageRoot = join(project, 'node_modules', '@mutantcat', 'dsh-desktop-host')
  mkdirSync(join(packageRoot, 'lib'), { recursive: true })
  writeFileSync(join(packageRoot, 'package.json'), '{"name":"@mutantcat/dsh-desktop-host","type":"module"}\n')
