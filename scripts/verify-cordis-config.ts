...
const CHOOSER_PACKAGE = '@mutantcat/dsh-host-directory-picker-auto'
...
const CHOOSER_BACKEND_PACKAGES = [
  '@mutantcat/dsh-host-directory-picker-native',
  '@mutantcat/dsh-host-directory-picker-browse',
  '@mutantcat/dsh-client-ui-directory-picker-browse',
  '@mutantcat/dsh-client-ui-directory-picker-native',
]
const errors: string[] = []
...
function validateEntry(value: unknown, file: string, path: string): void {
  ...
  if (value.name !== '@mutantcat/cordis-plugin-include') return
