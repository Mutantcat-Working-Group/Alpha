/** Package-owned session-event invariants for sandbox policy. @module @mutantcat/dsh-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@mutantcat/dsh-sandbox-policy'
