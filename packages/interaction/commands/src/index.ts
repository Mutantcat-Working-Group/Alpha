 ...
 * @module @mutantcat/dsh-commands
 */

import { Context } from '@mutantcat/cordis'
import { randomUUID } from '@mutantcat/dsh-util-crypto'
import type { Agent } from '@mutantcat/dsh-agent'
import { AttachmentError, admitEncodedImages } from '@mutantcat/dsh-attachment'
import type { EncodedImageAttachment, FileAttachmentRef, ImageAttachmentRef } from '@mutantcat/dsh-attachment/types'
import type { FileBlock, ImageBlock } from '@mutantcat/dsh-llm'
import { NamedEntries, ScopedLayers } from '@mutantcat/dsh-scope'
import type { ScopeKey, ScopeLayer } from '@mutantcat/dsh-scope'
import { SessionSeq } from '@mutantcat/dsh-session'
import type { Session, SessionEvent, SessionEventMap } from '@mutantcat/dsh-session'
