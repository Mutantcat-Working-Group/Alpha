 ...
 * @module @mutantcat/dsh-client-test-runtime/src/assembly/modules
 */
import * as modulesClient from '@mutantcat/dsh-client-modules/client'
import { createClientModuleSystem } from '@mutantcat/dsh-client-modules/client'
import type { ClientModuleLoader, ClientModuleLoaderTarget, WebBootGraph } from '@mutantcat/dsh-client-modules/client'
...
export const MODULES_PACKAGE = '@mutantcat/dsh-client-modules'
 ...
 * statically imported `@mutantcat/dsh-client-modules/client` namespace.
