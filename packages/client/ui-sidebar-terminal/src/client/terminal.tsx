...
import { Button, IconPlusOutline16 } from '@mutantcat/dsh-client-ui-primitives'
import type { TerminalViewState, TerminalView } from '@mutantcat/dsh-api-terminal-controller/client'
import type { InjectFace, PropsLocale, PropsRuntime } from '@mutantcat/dsh-client-ui-slots'
import type { ThemeSnapshot } from '@mutantcat/dsh-client-ui-theme/client'
