...
import { apply, inject, SETTINGS_NS } from '@mutantcat/dsh-client-ui-theme/client'
import type { AppearanceRowInjected, FontSizeRowInjected, ThemeRuntime } from '@mutantcat/dsh-client-ui-theme/client'
