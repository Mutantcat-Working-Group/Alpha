 ...
 * @module @mutantcat/dsh-client-ui-message-feedback/client/slots
 */
...
import type { MessageFeedbackItem, MessageFeedbackRating } from '@mutantcat/dsh-message-feedback/types'
