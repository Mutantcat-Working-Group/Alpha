...
import type {} from '@mutantcat/dsh-plan-mode/client'
...
import { extractMarkdownPlainText } from '@mutantcat/dsh-client-ui-primitives'
...
export function apply(ctx: ClientContext): void {
  ...
  const previewId = '@mutantcat/dsh-client-ui-plan'
