...
import { Win32Error } from '@mutantcat/dsh-win32-process'
import { ERROR_BROKEN_PIPE } from '@mutantcat/dsh-win32-process/src/abi.ts'
import { processInformationType } from '@mutantcat/dsh-win32-process/src/ffi.ts'
