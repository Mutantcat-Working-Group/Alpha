...
class ScopedEventGenerator {
  ...
  render(): string {
    ...
    return [
      ...
      ' *',
      ' * @module @mutantcat/dsh-scope/scoped-events.generated',
      ' */',
      '',
...
/** Return whether an Events interface is inside declare module '@mutantcat/cordis'. */
function isCordisModuleInterface(node: ts.InterfaceDeclaration): boolean {
  ...
  return ts.isModuleBlock(block)
    ...
    && declaration.name.text === '@mutantcat/cordis'
}
