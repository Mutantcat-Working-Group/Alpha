 ...
 * @module @mutantcat/dsh-session-persistence-jsonl
 */
...
import { SESSION_FORMAT_VERSION, SessionId as makeSessionId, SessionLogOffset } from '@mutantcat/dsh-session'
import type { SessionEvent, SessionId, SessionHeader, SessionLogOffset as SessionLogOffsetType } from '@mutantcat/dsh-session'
import {
