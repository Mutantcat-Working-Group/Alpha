...
packages/    @mutantcat/dsh-<pkg> workspaces at packages/<group>/<pkg>/
...
native/      @mutantcat/node-addon-system source (native/README.md)
...
Packaging and signing: [required reading](apps/desktop/README.md#macos-code-signing).
