...
import AgentRegistry, { installModelSelection, type Agent, type ModelSelectionRef } from '@mutantcat/dsh-agent'
import AgentLoop from '@mutantcat/dsh-agent-loop'
import LlmRuntime, { createUserMessage, LlmError, type GenerateOptions } from '@mutantcat/dsh-llm'
import { toPiContext } from '@mutantcat/dsh-llm-pi-ai/src/context.ts'
