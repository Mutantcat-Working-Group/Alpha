...
import type { WebSearchProvider, WebSearchResult } from '@mutantcat/dsh-web'
...
} from '@mutantcat/dsh-tool-web'
import type { ContentBlock } from '@mutantcat/dsh-llm'
import type { ToolResult } from '@mutantcat/dsh-tools'
...
async function mountTools(opts: {
  ...
  fetchProvider?: import('@mutantcat/dsh-web').WebFetchProvider
