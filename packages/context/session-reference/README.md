...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-session-reference) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-session-reference) — every accepted config field and its source declaration.
