...
import { apply, inject, InputTriggerService } from '@mutantcat/dsh-client-ui-input-trigger/client'
import type { MenuViewInjected } from '@mutantcat/dsh-client-ui-input-trigger/client'
