 ...
 *
 * @module @mutantcat/dsh-tool-fs-search/search-core
 */
...
import { ItemRetainer, TextRetainer } from '@mutantcat/dsh-output-retention'
import type { RetainedItems } from '@mutantcat/dsh-output-retention'
import type { SubprocessHandle, SubprocessOutcome, SubprocessOutputRead, SubprocessSpawnSpec } from '@mutantcat/dsh-subprocess'
import type { SaveTextSpill, SpillRef } from '@mutantcat/dsh-spill'
import type { ToolExecution } from '@mutantcat/dsh-tools'
 ...
 * `@mutantcat/dsh-tool-call-timeout-policy` to enforce through `exec.signal`.
 */
 ...
 * (`@mutantcat/dsh-tool-call-timeout-policy`) and caller cancellation terminate the
 * process tree.
 *
 ...
 * retention pass both the model-facing render ({@link module:@mutantcat/dsh-tool-fs-search/grep}
 * `formatGrepOutput`) and the search-card projection
 * ({@link module:@mutantcat/dsh-tool-fs-search/presentation} `grepSearchMeta`)
