...
The remaining `watch*` fields tune Chokidar behavior — polling, stability window, interval, project cap, and symlink following. The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-skill-filesystem) is the exhaustive source for every field.
