...
import { Context, type FiberState } from '@mutantcat/cordis'
import Loader, { type Entry, type EntryOptions } from '@mutantcat/cordis-plugin-loader'
import Include, { applyEntryPatches, entryListSchema, type PatchOptions } from '@mutantcat/cordis-plugin-include'
 ...
 * entries (`@mutantcat/cordis-plugin-include`'s `PatchOptions`): id-targeted config
 ...
 * `@mutantcat/cordis-plugin-include` `PatchOptions` (id-targeted config overrides and
...
export async function mountRootInclude(
  ...
  // preset living outside this workspace cannot resolve `@mutantcat/cordis-plugin-group`
