...
import { LlmAdapter, ToolCallId } from '@mutantcat/dsh-llm'
import type { GenerateOptions, LlmResolvedModelInfo, StreamChunk } from '@mutantcat/dsh-llm'
import { canonicalPath, writableRoots } from '@mutantcat/dsh-sandbox'
import { SESSION_FORMAT_VERSION, SessionId, type SessionEvent } from '@mutantcat/dsh-session'
import { auditStartupEntries, composeEntries, loadOverlayPatches } from '@mutantcat/dsh-app-boot'
...
import type {} from '@mutantcat/dsh-permission-presets'
import type {} from '@mutantcat/dsh-agent-presets'
import type {} from '@mutantcat/dsh-commands'
import type {} from '@mutantcat/dsh-system-prompt'
import type {} from '@mutantcat/dsh-terminal'
...
it('assembles the shipped Web transport, catalog, guidance, and defaults', async () => {
  ...
  try {
    expect(scaffold.ctx.commands.list(commandHandle.agent)).toContainEqual({
      definitionId: '@mutantcat/dsh-command-feedback',
      name: 'feedback',
