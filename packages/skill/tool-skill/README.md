...
- name: '@mutantcat/dsh-skill-filesystem'
- name: '@mutantcat/dsh-tool-skill'
```
...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-tool-skill) is the exhaustive source for every accepted field.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#mutantcatdsh-tool-skill) — the exact `skill` schema the model receives.
...
The model sees the generated [`skill` schema](../../../docs/tool-catalog.md#mutantcatdsh-tool-skill).
