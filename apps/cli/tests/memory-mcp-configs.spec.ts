...
import { boot, loadOverlayPatches } from '@mutantcat/dsh-app-boot'
import SystemPrompt from '@mutantcat/dsh-system-prompt'
import ToolRuntime from '@mutantcat/dsh-tools'
import * as McpClient from '@mutantcat/dsh-mcp-client/src/index.ts'
...
describe('third-party memory MCP example overlays', () => {
  it.each(examples)('parses $file with the documented generic plugin fields', (contract) => {
    ...
    expect(row.name).toBe('@mutantcat/dsh-mcp-client')
