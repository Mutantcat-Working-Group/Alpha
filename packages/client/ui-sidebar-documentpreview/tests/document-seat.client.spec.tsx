...
import { absoluteFileAddress, sessionFileAddress } from '@mutantcat/dsh-util-workspace-path'
import { apply as resourcesApply, inject as resourcesInject } from '@mutantcat/dsh-client-resources/src/client/index.ts'
import { apply as sidebarApply, inject as sidebarInject } from '@mutantcat/dsh-client-ui-sidebar-right/src/client/index.ts'
