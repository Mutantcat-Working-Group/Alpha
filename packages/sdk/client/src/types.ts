 ...
 *
 * @module @mutantcat/dsh-sdk-client/types
 */

import type { ContentBlock, ReasoningEffortId } from '@mutantcat/dsh-llm'
import type { SdkPromptContentBlock } from '@mutantcat/dsh-sdk-protocol'
...
export interface HarnessClientOptions {
   ...
   * credential policy (see `scrubbedParentEnv` in `@mutantcat/dsh-subprocess`
