...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-subagent-codex) — every accepted config field and its source declaration.
