...
import { SlotCore, StaleAuthorizationError, standardHookPropName } from '@mutantcat/dsh-client-ui-slots'
import type {
...
export class SlotRegistry extends Service {
  ...
  private rebuildRootBinding(): void {
    ...
    const keyedHooks: Record<string, import('@mutantcat/dsh-client-ui-slots').KeyedStandardSource> = {}
