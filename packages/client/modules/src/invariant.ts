/**
 * Package-owned invariant companion for `@mutantcat/dsh-client-modules`.
 * @module @mutantcat/dsh-client-modules/invariant
 */
...
const PACKAGE_NAME = '@mutantcat/dsh-client-modules'
