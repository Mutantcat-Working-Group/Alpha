...
const aclRunner = process.platform === 'win32'
  ? fileURLToPath(import.meta.resolve('@mutantcat/dsh-sandbox-windows-acl/runner'))
  : undefined

if (aclRunner !== undefined && process.argv[2] === aclRunner) {
  process.argv.splice(1, 1)
  await import('@mutantcat/dsh-sandbox-windows-acl/runner')
  ...
  const { runSelectedSubprocessRunner } = await import('@mutantcat/dsh-subprocess-local/runner')
