...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-tool-todo) is the exhaustive source for the accepted field.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#mutantcatdsh-tool-todo) — the `todo_write` schema the model receives.
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-tool-todo) — every accepted config field and its source declaration.
