...
import { LAUNCHER_FAILURE_EXIT } from '@mutantcat/node-addon-system/landlock-run'
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@mutantcat/dsh-sandbox'
import type { SandboxPolicy } from '@mutantcat/dsh-sandbox'
import {
  LocalSandboxProvider,
} from '@mutantcat/dsh-sandbox-local'
import type { Config } from '@mutantcat/dsh-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @mutantcat/dsh-sandbox-windows-acl/tests/provider-chain.spec.ts
