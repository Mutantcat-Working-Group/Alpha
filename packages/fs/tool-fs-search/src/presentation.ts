 ...
 * model-facing render consumes ({@link module:@mutantcat/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @mutantcat/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@mutantcat/dsh-tool-fs-search/grep} `formatGrepMatches`), so
