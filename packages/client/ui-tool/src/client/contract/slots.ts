...
import type { OpenFileOptions, ToolCallBlock } from '@mutantcat/dsh-client-ui-chat/client'
import type { MessageImageLoader, MessageImageSource } from '@mutantcat/dsh-client-ui-conversation/client'
