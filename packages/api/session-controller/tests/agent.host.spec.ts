...
import SessionStore, { SESSION_FORMAT_VERSION, SessionLogOffset, SessionId } from '@mutantcat/dsh-session'
import type { SessionEvent, SessionHeader } from '@mutantcat/dsh-session'
import { SessionAlreadyOwnedError } from '@mutantcat/dsh-session-persistence'
