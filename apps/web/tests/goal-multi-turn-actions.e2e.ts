...
import type {} from '@mutantcat/dsh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@mutantcat/dsh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@mutantcat/dsh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@mutantcat/dsh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@mutantcat/dsh-skill-filesystem"}\n',
