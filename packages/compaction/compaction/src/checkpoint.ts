 ...
 *
 * The seam itself lives in `@mutantcat/dsh-compaction`, which re-exports these
 ...
 *
 * @module @mutantcat/dsh-compaction/checkpoint
 */

import type { MessageSource } from '@mutantcat/dsh-llm/message'
