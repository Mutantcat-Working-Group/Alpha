...
```yaml
- name: '@mutantcat/dsh-agent-presets'
  config:
    default: standard
    roots:
...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-agent-presets) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-agent-presets) — every accepted config field and its source declaration.
