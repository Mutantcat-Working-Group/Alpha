...
import CommandRuntime, { type CommandResult } from '@mutantcat/dsh-commands'
import {
  CompactionId,
  CompactionEngine,
...
import * as commandCompact from '@mutantcat/dsh-command-compact'
...
describe('@mutantcat/dsh-command-compact registration', () => {
  it('registers one argument-free command with Loader-safe exports and disposes it', async () => {
    ...
    expect(test.ctx.commands.list(test.agent)).toContainEqual({
      definitionId: '@mutantcat/dsh-command-compact',
      name: 'compact',
