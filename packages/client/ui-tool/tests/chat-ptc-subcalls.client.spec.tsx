...
import { en as conversationEn, NS as CONVERSATION_NS, zh as conversationZh } from '@mutantcat/dsh-client-ui-conversation/src/client/locales.ts'
import { apply as applyChat, inject as injectChat } from '@mutantcat/dsh-client-ui-chat/client'
