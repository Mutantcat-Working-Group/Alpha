...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-subagent-spawn-in-process) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-subagent-spawn-in-process) — every accepted config field and its source declaration.
