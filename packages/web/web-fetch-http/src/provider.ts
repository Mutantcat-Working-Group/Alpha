 ...
 * and leaves presentation to `@mutantcat/dsh-tool-web`. Requests carry no browser cookies
 * or ambient credentials.
 * @module @mutantcat/dsh-web-fetch-http/provider
 */

import { WebError } from '@mutantcat/dsh-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@mutantcat/dsh-web'
import { deadline, timeoutOf } from '@mutantcat/dsh-timeout'
import type { Response } from 'undici'
import { proxyRouteFor } from '@mutantcat/dsh-http-proxy'
