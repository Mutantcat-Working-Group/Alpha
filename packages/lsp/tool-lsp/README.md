...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-tool-lsp) is the exhaustive source for every accepted field.
...
The model sees the generated [`lsp` schema](../../../docs/tool-catalog.md#mutantcatdsh-tool-lsp).
