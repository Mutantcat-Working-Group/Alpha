...
const test = createClientTest({ roster: webApp.closure(['@mutantcat/dsh-api-gateway']) })
...
const missingConnection = createClientTest({ roster: webApp.pick(['@mutantcat/dsh-typert-registry']) })
