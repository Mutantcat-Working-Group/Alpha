...
所有设置都可选；默认会把文本超过 8,192 个字符的结果修剪为其前 4,096 加后 1,024 个字符，并用标记连接。生成的[配置目录](../../../docs/config-catalog.zh.md#mutantcatdsh-compaction-tool-result-pruner)是涵盖所有配置字段的真源。
...
- [生成配置目录](../../../docs/config-catalog.zh.md#mutantcatdsh-compaction-tool-result-pruner)——每个受支持配置字段及其源声明。
