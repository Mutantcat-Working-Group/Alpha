...
import SessionStore, { foldSurface, Session, SessionId } from '@mutantcat/dsh-session'
import * as commandFeedback from '@mutantcat/dsh-command-feedback'
import type { FeedbackRecord } from '@mutantcat/dsh-command-feedback/types'
import { remoteMethods } from '@mutantcat/dsh-typert-protocol'
...
vi.mock('@mutantcat/dsh-anonymous-user-id', () => ({
...
describe('@mutantcat/dsh-command-feedback registration', () => {
