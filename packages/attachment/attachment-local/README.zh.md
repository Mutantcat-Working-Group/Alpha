...
生成的[配置目录](../../../docs/config-catalog.zh.md#mutantcatdsh-attachment-local)完整列出了所有受支持的字段及其 JSDoc。
...
- [生成配置目录](../../../docs/config-catalog.zh.md#mutantcatdsh-attachment-local)——每个受支持配置字段及其源声明。
