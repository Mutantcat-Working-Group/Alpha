...
```yaml
- name: '@mutantcat/dsh-tmux-context'
  config:
...
The generated [configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-tmux-context) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#mutantcatdsh-tmux-context) — every accepted config field and its source declaration.
